function t396__parseGlobalStyleCSSVar(t) {
  try {
    ...
    var r = i[0],
      ...
      s;
    if (!(r && n && a && l && d)) return;
    return { parent: { id: l, type: n }, fallback: window.getComputedStyle(document.body).getPropertyValue(o) || d, field: a };
  } catch (u) {
...
function t396__setOverflowToAllRecords() {
  ...
  if (t) {
    var e = [".t951__sidebar_sticky", ".t1206__content_sticky", ".t754__col_fixed", ".t776__col_fixed", ".t786__col_fixed", ".t-store__prod-popup__col_fixed"];
...
function t396__generateOverflowStyle() {
  if (!document.getElementById("t396__overflow-styles")) {
    ...
    ((t.id = "t396__overflow-styles"),
      (t.innerHTML = ".t-records__overflow-clip { overflow: clip; }\n\t\t\t\t\t\t.t-records__overflow-hidden { overflow: hidden; }"),
  ...
  if (r) {
    ...
    if (u) {
      ...
      (f(),
        ...
        new MutationObserver(f).observe(r, { subtree: !0, characterData: !0, characterDataOldValue: !0 }),
    ...
    (a.classList.contains("t235__beforeready") || (e && e.closest("#allrecordstable")) || a.querySelector('[data-record-type="263"]')) &&
      i &&
      r &&
      i.addEventListener("displayChanged", function () {
        (t396_allelems__renderView(r), t396_allgroups__renderView(r), t396_doResize(t, !0));
    ...
    (e &&
      ...
      window.t396__isMobile || u || t396__removeInlineHeight([r, r.querySelector(".t396__carrier"), r.querySelector(".t396__filter")]),
      l || t396__intializeUndercut(e));
  }
}
((window.t396__isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || navigator.userAgent.indexOf("Instagram") > -1),
...
function t396__getWindowDimensions(t) {
  var e,
    ...
    n;
  return ((r || o) && t396__updateWindowDimensions(), { width: window.tn.window_width, height: window.tn.window_height, cssWidth: window.tn.window_width_css });
}
  ...
  if ("hug" === t.getAttribute("data-artboard-heightmode")) {
    ...
    if (!(Math.abs(r - o) <= 0.7)) {
      var n,
        ...
        d;
      (l === window.tn[a].curResolution_max ? t.setAttribute("data-artboard-height", r) : t.setAttribute("data-artboard-height-res-" + l, r),
        t396_ab__renderView(t),
        null == (e = t.closest(".t396")) || e.dispatchEvent(new CustomEvent("zero:height-changed")));
    }
  }
}
  ...
  if (i && !o && n) {
    ...
    e = r.reduce(function (e, r) {
      ...
      var _ = r.offsetTop + r.offsetHeight + l,
        ...
        u,
        c;
      "window" !== t396_ab__getFieldValue(t, "upscale") || window.tn.isEditMode || (_ *= t396__getCurrentScaleFactor(t.getAttribute("data-artboard-recid")));
      return _ > e ? _ : e;
    }, -1 / 0);
  return e === -1 / 0 ? 0 : e;
}
...
function t396__ab__getPaddingValue(t, e) {
  var i = (t396_ab__getFieldValue(t, "padding") || "0px 0px 0px 0px").split(" "),
    r = { paddingtop: i[0], paddingright: i[1], paddingbottom: i[2], paddingleft: i[3] };
    ...
    if ("fixed" !== e) {
      ...
      if ("absolute" === e) {
        var r = getComputedStyle(t),
          ...
          a,
          l = "rgba(0, 0, 0, 0)" === r.backgroundColor && "none" === r.backgroundImage && n ? "add" : "remove";
        t.classList[l](i);
...
function t396_updateTNobj(t) {
  for (var e, i = t396__getWindowDimensions().width, r = "ab" + t, o = window.tn[r].screens.slice().reverse(), n = 0; n < o.length; n++)
    window.tn[r].curResolution === o[n] && ((window.tn[r].canvas_min_width = o[n]), (window.tn[r].canvas_max_width = 0 === n ? i : o[n - 1]));
...
function t396_artboard_build(t, e) {
  ...
  if (r) {
    ...
    (Array.prototype.forEach.call(o, function (t) {
      ...
      r.dispatchEvent(new Event("artBoardRendered", { bubbles: !0, cancelable: !0 })));
      ...
      switch (e) {
        ...
        case "width":
          ...
          var u = t396_elem__getFieldValue(i, "widthmode"),
            c;
          if (
            ((c = t396_elem__getFieldValue(i, "textfit")) || ("button" === d ? (c = "fixedsize") : "text" === d && (c = "autoheight")),
        ...
        case "height":
          ...
          if (
            ((c = t396_elem__getFieldValue(i, "textfit")) || ("button" === d ? (c = "fixedsize") : "text" === d && (c = "autoheight")),
            ("text" === d || "button" === d) && ["autowidth", "autoheight", "singleline"].includes(c))
          )
...
function t396_elem__setGallerySize(t, e, i) {
  ...
  a = "width" === e || "height" === e ? t396__zoomifyValue(t, a, { round: !0 }) : t396__zoomifyValue(t, a);
  ...
  switch (e) {
    case "left":
      ...
      if (
        ...
        "%" === t396_elem__getFieldValue(r, "leftunits") && (y = t396_roundFloat((V * y) / 100)),
        v)
      ) {
        var O = parseInt(t396_group__getFieldValue(b, "left"), 10),
          q;
        ("%" === t396_group__getFieldValue(b, "leftunits") && (O = t396_roundFloat((V * O) / 100)), (y -= O));
        break;
      }
      (!u && d ? "grid" === h && c && (y *= z) : (y = A + y),
        "center" === p && ((x = t396_elem__getWidth(r)), f && "window" !== F && ((V *= z), (x *= z)), (y = V / 2 - x / 2 + y)),
        "right" === p && ((x = t396_elem__getWidth(r)), f && "window" !== F && ((V *= z), (x *= z)), (y = V - x + y)),
        f && "window" !== F && (y += ((x = t396_elem__getWidth(r)) * z - x) / 2));
      break;
    case "top":
      ...
      if (
        ...
        var M = parseInt(t396_group__getFieldValue(b, "top"), 10),
          N;
        ("%" === t396_group__getFieldValue(b, "topunits") && (M = t396_roundFloat((k * M) / 100)), (y -= M));
        break;
      }
      (f && "window" !== F && (y *= z), g && "window" !== F && (S = "stretch" === l ? 0 : S / z), (y = S + y));
      ...
      if (
        ...
        "center" === w &&
          ((E = H(r)),
          f && "window" !== F && ("stretch" !== l ? (k *= z) : (k = Z ? (Z > G ? Z : G) : T.clientHeight), (E *= z)),
          u || !d || c || "window" === F || "stretch" !== l || ((k = Z ? (Z > G ? Z : G) : T.clientHeight), (k /= z)),
          (y = k / 2 - E / 2 + y)),
        "bottom" === w &&
          ((E = H(r)),
          f && "window" !== F && ("stretch" !== l ? (k *= z) : (k = Z ? (Z > G ? Z : G) : T.clientHeight), (E *= z)),
...
function t396_allgroups__renderViewAutolayout(t) {
  if (t && t.classList.contains("t396__group-flex")) {
    ...
    "fill" === e
      ...
      : ((t.style.width = "hug" === e ? "min-content" : ""), (t.style.height = "hug" === i ? "initial" : ""), (t.style.flexShrink = ""));
  }
}
...
function t396_elem__getWidth(t, e) {
  var i = t396_getEl(t),
    ...
    _,
    s;
  (a || (a = t396_elem__getFieldValue(i, "width")), (a = parseFloat(a)), "%" === t396_elem__getFieldValue(i, "widthunits")) &&
    (a = "window" === t396_elem__getFieldValue(i, "container") ? (t396__getWindowDimensions().width * a) / 100 : (window.tn[n].grid_width * a) / 100);
  return a;
}
function t396_elem__getHeight(t, e) {
  ...
  var o = i.getAttribute("data-elem-type"),
    ...
    a;
  if (
    (n || ("button" === o ? (n = "fixedsize") : "text" === o && (n = "autoheight")),
    "shape" === o || "video" === o || "html" === o || "gallery" === o || (("text" === o || "button" === o) && "fixedsize" === n))
  ) {
    var l;
    ...
    Array.prototype.forEach.call(t, function (t) {
      ...
      if ("text" === e || "image" === e || "shape" === e || "button" === e || "vector" === e) {
        ...
        if (o && !n) {
          ...
          ("matrix(1, 0, 0, 1, 0, 0)" === l && (l = "none"), "none" !== l && i.push({ element: t, atom: a, atomTransform: l }));
        }
      }
    });
  }),
      ...
      if ("text" === t.getAttribute("data-elem-type")) {
        ...
        if (r && !t396__isInsideGroupWithZoom(t)) {
          var o = t.style.zoom,
            ...
            a = r.style.fontSize;
          i.push({ element: t, atom: r, zoom: o, textSizeAdjust: n, fontSize: a });
        }
      }
    });
  }),
    e.write(function () {
      i.forEach(function (t) {
        (t.atom.style.removeProperty("line-height"),
          window.t396__isSafari && t.zoom && ((t.atom.style.webkitTextSizeAdjust = "none"), (t.atom.style.fontSize = ""), (t.element.style.zoom = "")));
      });
    }),
    e.read(function () {
      i.forEach(function (t) {
    ...
    e.write(function () {
      i.forEach(function (t) {
        ...
        (window.t396__isSafari &&
          t.zoom &&
          ((t.atom.style.webkitTextSizeAdjust = t.textSizeAdjust), (t.atom.style.fontSize = t.fontSize), t.zoom && (t.element.style.zoom = t.zoom)),
...
function t396__intializeUndercut(t) {
  if (t && t.querySelector(".ql-undercut")) {
    var e,
      i = "https://static.tildacdn." + t396__getRootZone() + "/js/tilda-undercut-1.0.min.js";
